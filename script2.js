...
// загрузка карточек на страницу через JS с помощью template
...
// работа с карточками (лайки, корзина, открытие попапа с картинкой) (перестало работать после загрузки карточек через JS)
